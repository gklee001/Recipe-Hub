...
const getUnsplashImages = (searchTerm = currentSearchTerm, apikey = UNSPLASH_API_KEY) => {
  $.ajax({
    ...
    .catch(err => {
      console.log('Error occured searching for Unsplash image (Code: ' + err);
    });
};
 ...
 * @param {string} apiKey the API key used to access spoonacular api
 */
const getRecipeAdvance = (filters, searchTerm, offset = requestOffset, limit = requestLimit, apiKey = SPOONACULAR_KEYS[3]) => {
 ...
 * @param {string} apiKey the API key used to access spoonacular api
 */
const getRecipeByIngredients = (ingredients, limit = requestLimit, isPantry = false, apiKey = SPOONACULAR_KEYS[3]) => {
 ...
 * @param {string} apiKey the API key used to access spoonacular api
 */
const getRandomRecipe = (limit = requestLimit, apiKey = SPOONACULAR_KEYS[3]) => {
  clearSearchResults();
 ...
 * @param {string} apiKey the API key used to access spoonacular api
 */
const getSimilarRecipeId = (id, limit = requestLimit, apiKey = SPOONACULAR_KEYS[3]) => {
  clearSearchResults();
 ...
 * @param {string} apiKey the API key used to access spoonacular api
 */
const getRecipeById = (id, apiKey = SPOONACULAR_KEYS[3]) => {
  // the url past to the request header
 ...
 * @param {string} apiKey the API key used to access spoonacular api
 */
const getRecipe = (searchTerm, offset = requestOffset, limit = requestLimit, apiKey = SPOONACULAR_KEYS[3]) => {
  // the url past to the request header
